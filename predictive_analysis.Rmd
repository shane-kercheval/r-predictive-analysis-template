...
concrete = fread('./data/concrete.csv')
...
if(refresh_models)
{
	...
	saveRDS(nlm_neur_net_basic, file = './data/nlm_neur_net_basic.RDS')
} else{
	nlm_neur_net_basic <- readRDS('./data/nlm_neur_net_basic.RDS')
}
...
if(refresh_models)
{
	...
	nlm_neur_net_basic_remove_corr <- train(target ~ ., data = regression_train[, recommended_columns_caret], method = 'nnet',
							...
							MaxNWts = parameter_neural_network_max_num_weights,
							maxit = parameter_neural_network_max_iterations)
	saveRDS(nlm_neur_net_basic_remove_corr, file = './data/nlm_neur_net_basic_remove_corr.RDS')
} else{
	nlm_neur_net_basic_remove_corr <- readRDS('./data/nlm_neur_net_basic_remove_corr.RDS')
}
...
if(refresh_models)
{
	...
	nlm_neur_net_averaging_remove_corr <- train(target ~ ., data = regression_train[, recommended_columns_caret], method = 'avNNet',
							...
							MaxNWts = parameter_neural_network_max_num_weights,
							maxit = parameter_neural_network_max_iterations)
	saveRDS(nlm_neur_net_averaging_remove_corr, file = './data/nlm_neur_net_averaging_remove_corr.RDS')
} else{
	nlm_neur_net_averaging_remove_corr <- readRDS('./data/nlm_neur_net_averaging_remove_corr.RDS')
}
...
if(refresh_models)
{
	...
	saveRDS(tree_m5, file = './data/tree_m5.RDS')
} else{
	tree_m5 <- readRDS('./data/tree_m5.RDS')
}
tree_m5$finalModel
...
if(refresh_models)
{
	...
	saveRDS(tree_m5rules, file = './data/tree_m5rules.RDS')
} else{
	tree_m5rules <- readRDS('./data/tree_m5rules.RDS')
}
...
if(refresh_models)
{
	...
	saveRDS(ensemble_random_forest_cond_inf, file = './data/ensemble_random_forest_cond_inf.RDS')
} else{
	ensemble_random_forest_cond_inf <- readRDS('./data/ensemble_random_forest_cond_inf.RDS')
}
...
min_rmse <- min(final_models_metrics$rmse)
