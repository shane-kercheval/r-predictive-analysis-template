...
train_classification <- function(	model_name,
	...
	#therefore, we are still using the same 'unseen' data to calculate the ideal threshold point, so that when we hand off the threshold to the actual holdout set, it will be less biased than if we determined based on raw training set.
