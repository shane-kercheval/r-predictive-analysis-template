...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'k_nearest_neighbors', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'naive_bayes', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'rpart_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'rpart_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'treebag_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'treebag_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'c50_model_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'c50_model_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'c50_rules_model_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'c50_rules_model_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'rf_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'rf_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'adaboost_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'adaboost_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'adabag_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'adabag_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'gbm_independent_categories', training_preProcess = I(list(model_pre_processing))))
...
model_preprocessing_values <- rbind(model_preprocessing_values, data.frame(model = 'gbm_grouped_categories', training_preProcess = I(list(model_pre_processing))))
...
model_plots <- function(model, testing_set, prediction_threshold = 0.5){
	...
	###########################################################
	model_roc <- roc(df_results$actual_observations, df_results$predicted_probabilities, levels = rev(c(target_positive_class, target_negative_class)))
	...
	print(model$model_info$label)
	print(cutoff_closest_topleft)
	print(cutoff_youden)
	...
	print(visualize_quality_of_model(confusion_ls_topleft, chart_title = paste0('Quality of Model (using calculated probability threshold, ', round(cutoff_closest_topleft['threshold'], 3),')')))
