...
spot_check_models <- tribble(
	...
	#'nnet', 'neural_network', recommended_columns_caret, preProc=c('nzv', 'center', 'scale'), expand.grid(size = tuning_nnet_size, decay = tuning_nnet_decay), NULL, NULL, 5, c(target_positive_class, target_negative_class), NULL, NULL,
	)
