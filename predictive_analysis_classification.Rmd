...
model_plots <- function(model, testing_set, prediction_threshold = 0.5){
	...
	print(expected_value_chart(predicted_probabilities_positive = predicted_probabilities_positive, actual_outcomes = actual_observations == 'yes', gain_cost_matrix = gain_cost_matrix))
